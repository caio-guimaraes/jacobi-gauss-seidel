...
void gauss_csr(std::vector<int> values, std::vector<int> column_index, std::vector<int> row_index, std::vector<float> b, float epsilon, int max_iter){
    std::cout << "\nCSR GAUSS-SEIDEL" << std::endl;
